...
import { faCircle, faCompass } from "@fortawesome/free-regular-svg-icons";
...
const App = () => {
  ...
  return (
    <div className="App">
      <SearchBar faCircle={faCircle} faCompass={faCompass} faCodepen={faCodepen} />
